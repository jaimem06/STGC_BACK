...
pub async fn create_item(
    ...
    let exists_sku = sqlx::query_scalar::<_, i64>("SELECT count(*) FROM inventario_items WHERE sku = $1 AND modulo = 'FINCA'")
    ...
    let exists_nombre = sqlx::query_scalar::<_, i64>("SELECT count(*) FROM inventario_items WHERE nombre = $1 AND modulo = 'FINCA'")
